# Generated by Django 3.2.8 on 2021-10-07 23:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('craeted', models.DateField(auto_now=True, verbose_name='Criação')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(choices=[('lni-cog', 'Engrangem'), ('lni-stats-up', 'Gráfico'), ('lni-users', 'Usuários'), ('lni-layers', 'Desing'), ('lni-mobile', 'Mobile'), ('lni-rocket', 'Foguete')], max_length=12, verbose_name='Icone')),
            ],
            options={
